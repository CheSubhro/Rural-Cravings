...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex bg-white">
                ...
                <div className="absolute inset-0 flex flex-col justify-between p-12 text-white bg-linear-to-t from-black/60 via-transparent to-black/20">
                    ...
                    <div>
                        <h1 className="text-4xl font-black tracking-tight leading-tight mb-4">
                            Start Your Journey to Native Taste Today
                        </h1>
                        <p className="text-gray-200 text-base max-w-md font-medium leading-relaxed">
                            Sign up to unlock exclusive rural deals, track your traditional food cravings, and experience authentic heritage recipes.
                        </p>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-4 sm:px-12 bg-gray-50/30 lg:bg-white relative py-12">
