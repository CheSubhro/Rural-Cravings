...
const CheckoutSummary = ({ cartItems, totalCartPrice, discountAmount, deliveryFee, finalBill, loading }) => {
    ...
    return (
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-xs space-y-6 lg:sticky lg:top-6">
            ...
            <button 
                ...
                className="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white font-bold h-12 rounded-xl transition-all shadow-md shadow-emerald-100 flex items-center justify-center gap-2 cursor-pointer active:scale-[0.99]"
            >
                {loading ? (
